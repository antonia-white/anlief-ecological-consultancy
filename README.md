...
- __The landing page image - index.html__
  ...
  - The landing includes a photograph with text overlay to allow the user to see a quotation from a previously satisfied client.
...
- __About Section - index.html__
  ...
  - The about section will give the user an overview of the Anlief company and why they are considered the best Ecological Consultancy in South Wales. 
...
- Instructions on how to embed a Google map of Anlief's location were taken from [Campus WCMS](https://wcmshelp.ucsc.edu/advanced/embedding-google/google-maps.html)
...
- The photo used on the Home page are from the open source site [Unsplash](https://unsplash.com/)
